...
<body>
    ...
    <pre> &lt;ic:CropImage ID="CropImage1" runat="server"  Image="Image1" CanvasWidth="300" />   </pre>
    ...
    <pre> &lt;ic:CropImage ID="CropImage2" runat="server"  Image="Image2" CanvasWidth="300"  FixedAspectRatio="true"  />   </pre>
                    
    <asp:Image ID="Image2" runat="server" ImageUrl="images/328.jpg" /> <br />
    <ic:CropImage ID="CropImage2" runat="server"  Image="Image2" CanvasWidth="300" FixedAspectRatio="true" />   
    <asp:Button ID="Button2" runat="server" Text="Crop" onclick="btnCrop_Click" />

    <h3>Custom aspect ratio</h3>

    <pre> &lt;ic:CropImage ID="CropImage3" runat="server"  Image="Image3" CanvasWidth="300"  FixedAspectRatio="true" Ratio="16/9"  />   </pre>
                    
    <asp:Image ID="Image3" runat="server" ImageUrl="images/328.jpg" /> <br />
    <ic:CropImage ID="CropImage3" runat="server"  Image="Image3" CanvasWidth="300" FixedAspectRatio="true" Ratio="16/9" />   
    ...
    <pre> &lt;ic:CropImage ID="CropImage5" runat="server"  Image="Image5" CanvasWidth="300"  PreviewImageID="Preview5" PreviewHeight="150" PreviewWidth="150"/>   </pre>
    <asp:Panel ID="Preview5" runat="server"></asp:Panel>

    <asp:Image ID="Image5" runat="server" ImageUrl="images/328.jpg" /> <br />
    <ic:CropImage ID="CropImage5" runat="server"  Image="Image5" CanvasWidth="300" PreviewImageID="Preview5" PreviewHeight="150" PreviewWidth="150" />   
    <asp:Button ID="Button5" runat="server" Text="Crop" onclick="btnCrop_Click" />

    <h3>Crop with server-side source file resizing</h3>

      <pre> &lt;ic:CropImage ID="CropImage6" runat="server"  Image="Image6" CanvasWidth="300"  ServerSizeResize="true" />   </pre>
    
    <asp:Image ID="Image6" runat="server" ImageUrl="images/328.jpg" /> <br />
    <ic:CropImage ID="CropImage6" runat="server"  Image="Image6" CanvasWidth="300"  ServerSizeResize="true" />   
    <asp:Button ID="Button6" runat="server" Text="Crop" onclick="btnCrop_Click" />

        <h3>Crop with min/max size of 100,100 and 150,1500</h3>

    <pre> &lt;ic:CropImage ID="CropImage7" runat="server"  Image="Image7" MinSize="100,100" MaxSize="150,150" />   </pre>
                    
    <asp:Image ID="Image7" runat="server" ImageUrl="images/328.jpg" /> <br />
    <ic:CropImage ID="CropImage7" runat="server"  Image="Image7" CanvasWidth="300" MinSize="100,100" MaxSize="150,150" />   
    <asp:Button ID="Button7" runat="server" Text="Crop" onclick="btnCrop_Click" />


            <h3>Provide a default selection rectangle</h3>

    <pre> &lt;ic:CropImage ID="CropImage8" runat="server"  Image="Image8"  X="100" Y="100" W="100" H="100" />   </pre>
                    
    <asp:Image ID="Image8" runat="server" ImageUrl="images/328.jpg" /> <br />
    <ic:CropImage ID="CropImage8" runat="server"  Image="Image8" CanvasWidth="300" X="100" Y="100" W="100" H="100" />   
    ...
    <pre> &lt;ic:CropImage ID="CropImage9" runat="server"  Image="Image9" CanvasWidth="300"  Ratio="16/9"  FixedAspectRatioCheckboxID="fixedRatio" />   </pre>
                    
    <asp:Image ID="Image4" runat="server" ImageUrl="images/328.jpg" /> <br />
    <ic:CropImage ID="CropImage4" runat="server"  Image="Image4" CanvasWidth="300" Ratio="16/9" FixedAspectRatioCheckboxID="fixedRatio" />   
